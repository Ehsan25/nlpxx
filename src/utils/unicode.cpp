...
std::string nlpxx::utils::to_utf8(const std::u16string &str)
{
    return std::wstring_convert<std::codecvt_utf8_utf16<char16_t>, char16_t>().to_bytes(str);
}

std::string nlpxx::utils::to_utf8(const std::u32string &str)
{
    return std::wstring_convert<std::codecvt_utf8<char32_t>, char32_t>().to_bytes(str);
}

std::u16string nlpxx::utils::to_utf16(const std::string &str)
{
    return std::wstring_convert<std::codecvt_utf8_utf16<char16_t>, char16_t>().from_bytes(str);
}

std::u16string nlpxx::utils::to_utf16(const std::u32string &str)
{
...
std::u32string nlpxx::utils::to_utf32(const std::string &str)
{
    return std::wstring_convert<std::codecvt_utf8<char32_t>, char32_t>().from_bytes(str);
}

std::u32string nlpxx::utils::to_utf32(const std::u16string &str)
{
